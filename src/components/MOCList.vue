<template>
  <div class="dashboard">
    <div class="text-h5 text-left mb-2">Assigned MOCs</div>
    <v-divider></v-divider>
  ...
  data: () => ({
    ...
    items: [
      ...
      },
      {
        ...
        stage: "FC",
        pendingWith: "Mohammed Al-Shammri",
      },
      {
        id: "500000010012",
      ...
      },
      {
        ...
        stage: "CDP",
        pendingWith: "Abdullah Al-Ghamdi",
      },
    ],
  }),
  mounted() {},
